...
var actionMap = {
    init: {
        ...
        usages: ['god-clis init templateName projectName']
    },
    config: {
        alias: 'cfg',
        description: 'config .godclisrc',
        usages: ['god-clis config set <k> <v>', 'god-clis config get <k>', 'god-clis config remove <k>']
